  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="Homes" component={BodyComponent} options={{ headerShown: false }} />
        <Stack.Screen name="FirstStation" component={FirstStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="SecondStation" component={SecondStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="ThirdStation" component={ThirdStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="FourthStation" component={FourthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="FifthStation" component={FifthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="SixthStation" component={SixthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="SeventhStation" component={SeventhStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="EighthStation" component={EighthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="NinthStation" component={NinthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="TenthStation" component={TenthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="EleventhStation" component={EleventhStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="TwelfthStation" component={TwelfthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="ThirteenthStation" component={ThirteenthStation}  options={{ headerShown: false }}  />
        <Stack.Screen name="FourteenthStation" component={FourteenthStation}  options={{ headerShown: false }}  />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
